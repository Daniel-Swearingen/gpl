...
Expression::Expression(Expression *e1 ,Operator_type op,Expression *e2) {
	if (e2 != NULL) {
		...
		if (op == SIN || op == COS || op == TAN || op == ASIN || op == ACOS || op == ATAN || op == SQRT) {
			setType(1);
		} else if (op == FLOOR || op == NOT || op == NEAR || op == TOUCHES) {
			setType(0);
...
int Expression::eval_int() {
	...
	if ((op = getOp()) == PLUS) {
		...
		if (l->getVar()->getExpression() != NULL && r->getVar()->getExpression() != NULL) {
			if (l->getVar()->getSymbol()->get_game_object_value(l->getVar()->getExpression()->eval_int())->touches(r->getVar()->getSymbol()->get_game_object_value(r->getVar()->getExpression()->eval_int()))) {
				value = 1;
			} else {
				value = 0;
			}
		} else if (l->getVar()->getExpression() != NULL && r->getVar()->getExpression() == NULL){
			if (l->getVar()->getSymbol()->get_game_object_value(l->getVar()->getExpression()->eval_int())->touches(r->getVar()->getSymbol()->get_game_object_value())) {
				value = 1;
			} else {
				value = 0;
			}
		} else if (l->getVar()->getExpression() == NULL && r->getVar()->getExpression() != NULL) {
			if (l->getVar()->getSymbol()->get_game_object_value()->touches(r->getVar()->getSymbol()->get_game_object_value(r->getVar()->getExpression()->eval_int()))) {
				value = 1;
			} else {
				value = 0;
			}
		} else if (l->getVar()->getExpression() == NULL && r->getVar()->getExpression() == NULL) {
			if (l->getVar()->getSymbol()->get_game_object_value()->touches(r->getVar()->getSymbol()->get_game_object_value())) {
				value = 1;
			} else {
				value = 0;
			}
		...
		if (l->getVar()->getExpression() != NULL && r->getVar()->getExpression() != NULL) {
			if (l->getVar()->getSymbol()->get_game_object_value(l->getVar()->getExpression()->eval_int())->near(r->getVar()->getSymbol()->get_game_object_value(r->getVar()->getExpression()->eval_int()))) {
				value = 1;
			} else {
				value = 0;
			}
		} else if (l->getVar()->getExpression() != NULL && r->getVar()->getExpression() == NULL){
			if (l->getVar()->getSymbol()->get_game_object_value(l->getVar()->getExpression()->eval_int())->near(r->getVar()->getSymbol()->get_game_object_value())) {
				value = 1;
			} else {
				value = 0;
			}
		} else if (l->getVar()->getExpression() == NULL && r->getVar()->getExpression() != NULL) {
			if (l->getVar()->getSymbol()->get_game_object_value()->near(r->getVar()->getSymbol()->get_game_object_value(r->getVar()->getExpression()->eval_int()))) {
				value = 1;
			} else {
				value = 0;
			}
		} else if (l->getVar()->getExpression() == NULL && r->getVar()->getExpression() == NULL) {
			if (l->getVar()->getSymbol()->get_game_object_value()->near(r->getVar()->getSymbol()->get_game_object_value())) {
				value = 1;
			} else {
				value = 0;
			}
